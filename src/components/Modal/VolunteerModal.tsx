    ...
    <>
      <Modal opened={opened} onClose={close} title={"Register to Volunteer"}>
        ...
        >
          <Group mt="xs">
            <Radio
              value="This is an event I feel passionately about"
              label="This is an event I feel passionately about"
            />
            <Radio
              value="I have some free time and want to give back"
              label="I have some free time and want to give back"
            />
            <Radio
              value="I want to try something new"
        ...
        <Group>
          <NumberInput
            ...
            withAsterisk
            description="Please indicate how many hours you think you’d be available to help out. It’s not mandatory to stay for the entire event time"
            value={hoursOfAvailability}
            onChange={setHours}
        ...
        <Group mt="xs">
          <Button
            onClick={() =>
              register(email, opportunityId.eid, reason, hoursOfAvailability)
            }
            color="black"
            radius="md"
            style={{ flex: 1 }}
